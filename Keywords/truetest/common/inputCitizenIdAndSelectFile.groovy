...
public class inputCitizenIdAndSelectFile {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Enter input value in input citizenId2"
        
        WebUI.setText(findTestObject('AI-Generated/Page_user_create_notarization_profile/input_citizenId2_1'), data['input_citizenId2'])
        
        "Step 2: Click on input email2"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_user_create_notarization_profile/input_email2_1'))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['input_citizenId2'] = testData.getValue('input_citizenId2', rowIndex)
    ...
    private static def execute_without_data_source() {
        Map data = [:]
        data['input_citizenId2'] = 'default_data'
