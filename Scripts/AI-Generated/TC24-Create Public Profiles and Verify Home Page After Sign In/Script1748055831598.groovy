...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 6-Click on button linkedIn.png')

"Step 7: Click on link signIn -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/dispute-resolution?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dispute_resolution/link_signIn'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 7-Click on link signIn - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Create Public Profiles and Verify Home Page After Sign In_visual_checkpoint')
