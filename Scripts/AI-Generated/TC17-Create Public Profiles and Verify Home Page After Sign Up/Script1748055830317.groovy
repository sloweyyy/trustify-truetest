...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 7-Click on link signIn - Navigate to page signin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 8-Click on link signUp.png')

"Step 9: Sign up with Google multiple times using the sign-up form"

signUpWithGoogleMultipleTimes.execute()

"Step 10: Click on button signUpWithGoogle"
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 10-Click on button signUpWithGoogle.png')

"Step 11: Click on link signIn -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/signup?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_signup/link_signIn'))

WebUI.takeScreenshot(reportLocation + '/TC17/Step 11-Click on link signIn - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Create Public Profiles and Verify Home Page After Sign Up_visual_checkpoint')
