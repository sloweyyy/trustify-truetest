...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on button linkedIn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 7-Click on link signIn - Navigate to page signin.png')

"Step 8: Click on link signUp"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/signin?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_signin/link_signUp_1'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 8-Click on link signUp.png')

"Step 9: Attempt multiple sign ups using Google account."
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 10-Click on button signUpWithGoogle2.png')

"Step 11: Click on link signInAlternative -> Navigate to page 'signin'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/signup?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_signup/link_signInAlternative'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 11-Click on link signInAlternative - Navigate to page signin.png')

"Step 12: Click on button signInWithGoogle -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/signin?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_signin/button_signInWithGoogle'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 12-Click on button signInWithGoogle - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Create Public Profile and Access Services_visual_checkpoint')
