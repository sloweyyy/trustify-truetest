...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6-Click on button linkedIn.png')

"Step 7: Sign up with Google multiple times using the sign-up form"

signUpWithGoogleMultipleTimes.execute()

"Step 8: Click on button signUpWithGoogle -> Navigate to page '/signin'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Click on button signUpWithGoogle - Navigate to page signin.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Create Public Profiles and Verify Sign In Access_visual_checkpoint')
