...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 6-Click on button linkedIn.png')

"Step 7: Attempt multiple sign ups using Google account."

signUpWithGoogleMultipleAttempts.execute()

"Step 8: Click on button signUpWithGoogle2 -> Navigate to page 'signin'"
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 8-Click on button signUpWithGoogle2 - Navigate to page signin.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Create Public Profile and Sign Up Process_visual_checkpoint')
