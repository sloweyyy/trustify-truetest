...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 6-Click on button linkedIn - Navigate to page signin.png')

"Step 7: Click on link signUp2"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 7-Click on link signUp2.png')

"Step 8: Attempt multiple sign ups using Google account."

signUpWithGoogleMultipleAttempts.execute()

"Step 9: Click on button signUpWithGoogle2 -> Navigate to page 'signin'"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 9-Click on button signUpWithGoogle2 - Navigate to page signin.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC21-Create Public Profile and Verify Sign In with Google_visual_checkpoint')
