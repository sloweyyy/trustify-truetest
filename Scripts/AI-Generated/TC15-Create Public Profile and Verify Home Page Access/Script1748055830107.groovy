...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 3-Click on button createPublicProfile.png')

"Step 4: Click on link signIn -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/link_signIn'))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 4-Click on link signIn - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Create Public Profile and Verify Home Page Access_visual_checkpoint')
