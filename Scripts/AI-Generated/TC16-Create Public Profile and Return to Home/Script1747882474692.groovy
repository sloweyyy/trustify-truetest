...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3-Click on button createPublicProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 4-Click on link signIn - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Create Public Profile and Return to Home_visual_checkpoint')
