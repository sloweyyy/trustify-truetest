...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 7-Click on link signIn.png')

"Step 8: Sign up with Google multiple times using the sign-up form"

signUpWithGoogleMultipleTimes.execute()

"Step 9: Click on button signUpWithGoogle"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 9-Click on button signUpWithGoogle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 10-Click on link signIn - Navigate to page signin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 11-Click on button signInWithGoogle - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Create Public Profiles and Verify Home Page After Sign In_visual_checkpoint')
